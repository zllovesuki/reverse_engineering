 ...
 *
 * Disassembly of ./g14-dsdt.bin, Sat Aug 22 05:13:14 2020
 *
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xAC3B7000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xAC3BB000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD310510)
    Name (FTPM, 0xFD310510)
    Name (PPIM, 0xAC5C6F98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xAC5C9000, 0x0100)
    ...
    Scope (_SB)
    {
        ...
        Device (ATKD)
        {
            ...
            Method (WMNB, 3, Serialized)
            {
                ...
                If ((Local0 == 0x53545344))  // DSTS/DSTS2
                {
                    If ((IIA0 == 0x00010002))
                    {
                        Return (Zero)
                    ...
                    If ((IIA0 == 0x00010011)) // Wireless Device Presence flag
                    {
                        If (WLDP)
                        {
                            Return (0x00030001)
                    ...
                    If ((IIA0 == 0x00010013)) // Bluetooth Device Presence flag
                    {
                        If (BTDP)
                        {
                            Return (0x00030001)
            ...
            {
                IANQ (Arg0)
                Notify (ATKD, 0xFF) // Hardware-Specific, see wdg.txt
            }
    ...
    Scope (_SB.PCI0.SBRG.EC0)
    {
        ...
        {
            If (!(DSYN & One)) // (DSYN) 8 & 1 = 0, !0 = 1
            {
                If (ATKP)
                {
                    ^^^^ATKD.IANE (0x6B) // Notify WMI
                }
            }
            ElseIf (ATKP)
            {
    ...
    Scope (_SB.PCI0.SBRG.EC0)
    {
        Method (_QA2, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
        {
            ...
            If (ATKP)
            {
                ^^^^ATKD.IANE (0x7B) // 123, Power source changed
            }
        }
    }
